              ...
              <div class="row">
                <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <span>Citizen Disability</span>
                    </li>
                    <li>5754 Adavuruku Rd</li>
                    <li>Ajaokuta, KG, 36020</li>
                    <li>United States</li>
                    <li>888-777-6655</li>
                    <li>
                      <a href="#">citizendisability@example.com</a>
                    </li>
                  </ul>
                </div>
                <div class="col-sm-6 col-lg-5 col-xl-4 m-b-20">
                  ...
                  <ul class="list-unstyled invoice-payment-details">
                    <li>
                      <h5>
                        Total Due: <span class="text-right">$8,750</span>
                      </h5>
                    </li>
                    <li>
              ...
              <div>
                ...
                <div class="invoice-info">
                  ...
                  <p class="text-muted">
                    ...
                    eu finibus sapien interdum vel
                  </p>
                </div>
              </div>
            </div>
