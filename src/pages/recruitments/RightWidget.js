  ...
  return (
    <>
      <div className="job-det-info job-widget">
        ...
        <Link className="btn job-btn" to={"/recruitment/apply/" + id.id}>
          Apply For This Job
        </Link>
        ...
        <div className="info-list">
          ...
          {state?.location?.branch === "Abuja" ? (
            <p>
              {" "}
              Outsource Global Technologies <br /> 2nd Floor, ASTA GALLERY,
            ...
            <p>
              {" "}
              Outsource Global Technologies <br /> 47, Kanta Road, Unguwar,
              <br /> Rimi, Kaduna State
            </p>
          )}
        </div>
        <div className="info-list">
          <p>
            {" "}
            NG: +234 7006 8876 8723 <br /> info@outsourceglobal.com <br />{" "}
            https://www.outsourceglobal.com{" "}
          </p>
        </div>
        <div className="info-list text-center">
          {state.deadline ? (
            <a className="app-ends">
              Application ends on {new Date(state?.deadline).toDateString()}
            </a>
          ) : (
            ""
          )}
