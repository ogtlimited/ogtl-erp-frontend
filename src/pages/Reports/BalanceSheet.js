...
const BalanceSheet = () => {
    const [prevBalance, setPrevBalance] = useState(assets.reduce((a,b) => a.prev_balance+b.prev_balance, 0))
    const [currBalance, setCurrBalance] = useState(assets.reduce((a,b) => a.curr_balance+b.curr_balance, 0))
