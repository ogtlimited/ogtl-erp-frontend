...
const JobApplicants = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sort: true,
      formatter: (value, row) => <a href="#" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Download</a>
    },
    {
    ...
    },
    {
      ...
      sort: true,
      formatter: (value, row) => (
       value ? <a href="#" class="btn btn-sm btn-primary"><i class="fa fa-download"></i> Download</a> : ''
      )
    },
    {
      dataField: "",
