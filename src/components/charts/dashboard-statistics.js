    ...
    <>
            ...
            <div class="card-body">
              ...
              <div>
                <p>
                  ...
                  Tasks <span class="float-right">166</span>
                </p>
                <p>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
          <div class="card flex-fill">
            <div class="card-body">
              <h4 class="card-title">
                Today Absent <span class="badge bg-inverse-danger ml-2">5</span>
              </h4>
              <div class="leave-info-box">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="text-sm my-0">Iman Wada (Miss Leave)</div>
                  </div>
                </div>
                <div class="row align-items-center mt-3">
                  <div class="col-6">
                    <h6 class="mb-0">4 Sep 2021</h6>
              ...
              <div class="leave-info-box">
                <div class="media align-items-center">
                  ...
                  <div class="media-body">
                    <div class="text-sm my-0">Mazi Ogundu</div>
                  </div>
                </div>
                <div class="row align-items-center mt-3">
                  <div class="col-6">
