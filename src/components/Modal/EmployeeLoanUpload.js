...
const EmployeeLoanUpload = ({
  ...
  const uploadData = () => {
    setLoading(true);
    let obj = {};
    if (path === "/api/v1/bulk_loans.json") {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        showAlert(
          true,
          res?.data?.data?.salary || "Loans are being generated",
          "alert alert-success"
        );
...
export default EmployeeLoanUpload;
